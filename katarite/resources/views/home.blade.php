...
<main role="main" class="main-color">
    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="5000">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('storage/images/men.jpg') }}" alt="First Slied" class="img-fluid">
                <div class="container">
            ...
            <div class="carousel-item">
                    <img src="{{ asset('storage/images/teach.jpg') }}" alt="Third Slied" class="img-fluid">
                <div class="container">
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading">Katariteとは?</h2>
                <p class="lead">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="h2 mt-2 head-text">1人で悩まず相談しよう!</div>
                <p>
            ...
            <div class="col-lg-4">
                ...
                <div class="h2 mt-2 head-text">人々の知見を得よう!</div>
                <p>
            ...
            <div class="col-lg-4">
                ...
                <div class="h2 mt-2 head-text">経験が価値に変わる!</div>
                <p>
                    あなたの経験が、他の人々を救う時が来るかもしれません。自分では普通の人生だと思っていても、他の人にとって価値のある経験をしている可能性は十分にあります。クレジットカード決済で収入を得ることも可能で、料金はあなたが設定可能です。さあ、存分に語りましょう!
                </p>
                <p>
